...
const tabs: Tab[] = [
  ...
  { id: 'tab-2', title: 'Tab 2', content: ' В обширном зале-кабинете Гурзадяна покамест тепло от солнечной осени. Светло от его картин, как ковер покрывающих стены — алых маков, летних ущелий, привольных просторов с двуглавым Араратом. Столы, стулья, кресла завалены книгами, рукописями, ксерокопиями, глянцевитыми научными журналами, которые регулярно присылают из-за рубежа.' },
