...
1. The `Tabs` should show the content of the selected tab (add an attribute `data-cy="tab-content"` for testing).pwd
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://kolya-movchan.github.io/react_tabs/) and add it to the PR description.
