...
1. The selected tab (`li`) should have `is-active` class.e user selects another tab.
...
1. Pass the `onTabSelected` callback to the `Tabs`, it should be called whenever th)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://petrolozynskyi.github.io/react_tabs/) and add it to the PR description.
