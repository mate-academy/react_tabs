...
1. Implement `Tabs` component displaying tabs from a given array of objects
    ```javascript
    let tabs = [
      { title: 'Tabs 1', content: 'Some text 1' },
      { title: 'Tabs 2', content: 'Some text 2' },
      { title: 'Tabs 3', content: 'Some text 3' },
    ];
    ```
    ```jsx harmony
    <Tabs tabs={tabs} />
...
- Add links to your demo in readme.md.
  - `[DEMO LINK](https://olesmarola.github.io/react_tabs/)` - this will be a
