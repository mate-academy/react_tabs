...
> Here is [the working version](https://mate-academy.ginpthub.io/react_tabs)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://PaulMaistrenko.github.io/react_tabs/) and add it to the PR description.
