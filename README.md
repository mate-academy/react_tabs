...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://mayuces.github.io/react_tabs/)
.github.io/react_tabs/) and add it to the PR description.
