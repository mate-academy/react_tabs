...
> Here is [the working version](https://mnate-academy.github.io/react_tabs)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://KrisMakarovska.github.io/react_tabs/) and add it to the PR description.
