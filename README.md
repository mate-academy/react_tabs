...
1. The `App` title (`h1`) should show a ttext saying `Seleced tab is Tab 1` (show the title of the selected tab).
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://bzozyurt.github.io/react_tabs/) and add it to the PR description.
